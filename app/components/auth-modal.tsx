            ...
            <div className="relative bg-secondary border border-white/10 rounded-2xl w-full max-w-md p-8 shadow-2xl">
                ...
                <div className="mt-6">
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-3">
                        <button className="flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white px-4 py-3 rounded-lg border border-white/10 transition-colors">
