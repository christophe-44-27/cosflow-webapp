...
export function AuthModal({ isOpen, onClose, onLogin }: AuthModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
            ...
            {/* Modal */}
            <div className="relative bg-secondary border border-white/10 rounded-2xl w-full max-w-md p-8 shadow-2xl">
                {/* Close Button */}
                <button
                    onClick={onClose}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-white/5 text-white placeholder:text-white/40 rounded-lg py-3 pl-11 pr-4 border border-white/10 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
                                    required
                                />
                            </div>
                        </div>
                ...
                <div className="mt-6">
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-secondary text-white/60">{t.auth.orContinueWith}</span>
                        </div>
                    </div>

                    <div className="mt-4">
                        <button className="w-full flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 text-white px-4 py-3 rounded-lg border border-white/10 transition-colors">
