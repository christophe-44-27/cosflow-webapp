...
import { Camera, Users, Image, Calendar, Zap, Shield, Star, ArrowRight, CheckCircle, Smartphone, MessageCircle } from 'lucide-react';
import { ImageWithFallback } from './figma/ImageWithFallback';
import { useAuth } from '../lib/auth-context';

export function LandingView() {
    const { isLoggedIn, handleLogout, setShowAuthModal } = useAuth();
    // Liens pour les stores et Discord
    const PLAY_STORE_URL = 'https://play.google.com/store/apps/details?id=com.yourapp.cosflow'; // Remplacez par votre lien
    const DISCORD_URL = 'https://discord.gg/yourinvite'; // Remplacez par votre lien Discord
    ...
    return (
        <div className="min-h-screen">
            <Header title="Bienvenue" showSearch={false} />

            <div className="overflow-hidden pt-20 md:pt-0">
                {/* Hero Section */}
                <section className="relative px-6 md:px-8 py-6 md:py-20">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-8 md:mb-16">
                            <h1 className="text-white text-4xl md:text-6xl mb-3 md:mb-6">
                                Qu'est-ce que <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-tertiary">Cosflow</span> ?
                            </h1>
                            <p className="text-white/70 text-base md:text-xl max-w-2xl mx-auto mb-6 md:mb-8">
                                La plateforme tout-en-un pour gérer vos projets cosplay, collaborer avec des photographes et partager votre passion
                            </p>
                            <button
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                            {features.map((feature, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className="group bg-secondary border border-white/10 rounded-2xl p-8 hover:border-primary/50 transition-all cursor-pointer"
                                    >
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                            <div className="text-center">
                                ...
                                <h3 className="text-white text-xl mb-3">Créez votre compte</h3>
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="text-white text-xl mb-3">Organisez vos projets</h3>
                                <p className="text-white/70">
                                    Créez des projets, planifiez vos shoots et invitez vos collaborateurs
                                </p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="text-white text-xl mb-3">Partagez vos créations</h3>
                                <p className="text-white/70">
                                    Publiez vos photos et partagez-les avec votre communauté
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
                            <div>
                                <h2 className="text-white text-2xl md:text-4xl mb-4 md:mb-6">
                                    Pourquoi choisir Cosflow ?
                                </h2>
                                <p className="text-white/70 text-base md:text-lg mb-6 md:mb-8 leading-relaxed">
                                    Nous avons conçu Cosflow spécifiquement pour les besoins des cosplayers
                                    et photographes. Une solution complète qui comprend votre workflow.
                                </p>
                            ...
                            <div className="grid grid-cols-2 gap-4 md:gap-6">
                                <div className="space-y-4 md:space-y-6">
                                    <div className="bg-secondary border border-white/10 rounded-2xl p-4 md:p-6">
                                        ...
                                        <h4 className="text-white mb-2">Ultra rapide</h4>
                                    ...
                                    <div className="bg-secondary border border-white/10 rounded-2xl p-4 md:p-6">
                                        ...
                                        <h4 className="text-white mb-2">100% sécurisé</h4>
                                        <p className="text-white/70 text-xs md:text-sm">
                                ...
                                <div className="space-y-4 md:space-y-6 mt-6 md:mt-12">
                                    <div className="bg-secondary border border-white/10 rounded-2xl p-4 md:p-6">
                                        ...
                                        <h4 className="text-white mb-2">Communauté active</h4>
                                        <p className="text-white/70 text-xs md:text-sm">
                                    ...
                                    <div className="bg-secondary border border-white/10 rounded-2xl p-4 md:p-6">
                                        ...
                                        <h4 className="text-white mb-2">Gratuit</h4>
                                        <p className="text-white/70 text-xs md:text-sm">
                                            Commencez sans engagement, toutes les fonctionnalités incluses
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="relative overflow-hidden bg-gradient-to-br from-primary to-tertiary rounded-2xl md:rounded-3xl p-8 md:p-12 text-center">
                            ...
                            <div className="relative">
                                ...
                                <p className="text-white/90 text-base md:text-xl mb-6 md:mb-8">
                                    Rejoignez Cosflow aujourd'hui et transformez votre passion en projets organisés
                                </p>
                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-8 md:mb-16">
                            ...
                            <p className="text-white/70 text-base md:text-xl">
                                Profitez de Cosflow partout avec nos applications mobiles
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-start">
                            ...
                            <div className="bg-secondary border border-white/10 rounded-2xl p-8 text-center h-full flex flex-col">
                                ...
                                <h3 className="text-white text-xl mb-3">App Store</h3>
                                <p className="text-white/60 mb-6 flex-grow">Application iOS pour iPhone et iPad</p>
                                <button
                                    disabled
                                    className="w-full bg-white/10 text-white/40 px-6 py-3 rounded-lg cursor-not-allowed border border-white/10"
                                >
                                    Bientôt disponible
                                </button>
                            </div>
                            ...
                            <div className="bg-secondary border border-white/10 rounded-2xl p-8 text-center hover:border-primary/50 transition-all h-full flex flex-col">
                                ...
                                <h3 className="text-white text-xl mb-3">Google Play</h3>
                                <p className="text-white/60 mb-6 flex-grow">Application Android disponible maintenant</p>
                                <a
                                    href={PLAY_STORE_URL}
                                    target="_blank"
                            ...
                            <div className="bg-secondary border border-white/10 rounded-2xl p-8 text-center hover:border-primary/50 transition-all h-full flex flex-col">
                                ...
                                <h3 className="text-white text-xl mb-3">Discord</h3>
                                <p className="text-white/60 mb-6 flex-grow">Rejoignez notre communauté active</p>
                                <a
                                    href={DISCORD_URL}
                                    target="_blank"
                                    rel="noopener noreferrer"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mt-8 md:mt-16">
                            <div className="bg-secondary/50 border border-white/10 rounded-2xl p-6 flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="text-white mb-2">Synchronisation automatique</h4>
                                    <p className="text-white/70 text-sm">
                                        Vos données sont synchronisées en temps réel entre le web et l'application mobile
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-secondary/50 border border-white/10 rounded-2xl p-6 flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="text-white mb-2">Support communautaire</h4>
                                    <p className="text-white/70 text-sm">
                                        Une communauté active et réactive pour vous aider et partager vos expériences
                                    </p>
                                </div>
                            </div>
                        </div>
